...
P.P.S: представленная разбивка удобна только для маленьких проектов. Для больших следует делать:
...
Так проще контролировать код и предотвращать протекание абстракций (но больней и дольше разрабатывать)
